$title A Inceasing Return to Scale Model
$onsymxref
$onsymlist
$onuellist
$onuelxref
...
Const3..      Sum(j,Lambda(j))=g=1;
Const4(i)..   Sum(j,x(i,j)*Lambda(j))+s(i)=e=Teta.l*xo(i);
Const5(r)..   Sum(j,y(r,j)*Lambda(j))-t(r)=e=yo(r);

File IRTS_Model/Results.txt/ ;

Models IRTS_Phase1 /Objective1,Const1,Const2,Const3/
       IRTS_Phase2 /Objective2,Const3,Const4,Const5/;

Puttl IRTS_Model ,'Title ' System.title, @60 'Page ' System.page//;
...
Solve IRTS_Phase1 Using LP Minimizing z;
Solve IRTS_Phase2 Using LP Maximizing w;
