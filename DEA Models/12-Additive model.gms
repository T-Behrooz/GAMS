...
$ontext
Constant-return-to-scale Additive model
$offtext
$onsymxref
$onsymlist
$onuellist
...
DObjective..   zd=e=Sum(i,v(i)*xo(i))-Sum(r,yo(r)*u(r));
Const3(j)..    Sum(i,x(i,j)*v(i))-Sum(r,y(r,j)*u(r))=g=0;
Const4(i)..    v(i)=g=1;
Const5(r)..    u(r)=g=1;

Models P_Additive_Model /PObjective,Const1,Const2/
       D_Additive_Model /DObjective,Const3,Const4,Const5/;
...
Put @12'w', @19's(i1)', @29's(i2)', @37't(o1)', @46't(o2)', @54'Reference-Set'/;
...
Put @12'z', @19 'v(i1)',@29 'v(i2)',@39 'u(o1)',@49 'u(o2)'/;
