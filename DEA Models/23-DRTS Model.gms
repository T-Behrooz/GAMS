$title A Decreasing Return to Scale Model
$onsymxref
$onsymlist
$onuellist
$onuelxref
...
Const3..      Sum(j,Lambda(j))=l=1;
Const4..      Sum(j,Lambda(j))=g=0;
Const5(i)..   Sum(j,x(i,j)*Lambda(j))+s(i)=e=Teta.l*xo(i);
Const6(r)..   Sum(j,y(r,j)*Lambda(j))-t(r)=e=yo(r);

File DRTS_Model/Results.txt/ ;

Models DRTS_Phase1 /Objective1,Const1,Const2,Const3,Const4/
       DRTS_Phase2 /Objective2,Const3,Const4,Const5,Const6/;

Puttl DRTS_Model 'Title ' System.title,@60 'Page' System.page//;
...
Solve DRTS_Phase1 Using LP Minimizing z;
Solve DRTS_Phase2 Using LP Maximizing w;
