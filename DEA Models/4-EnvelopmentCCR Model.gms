...
Const3(i)..   Sum(j,x(i,j)*Lambda(j))+s(i)=e=Teta.l*xo(i);
Const4(r)..   Sum(j,y(r,j)*Lambda(j))-t(r)=e=yo(r);

File CCR_Model /Results.txt/ ;

Models CCR_Phase1 /Objective1,Const1,Const2/
       CCR_Phase2 /Objective2,Const3,Const4/;
